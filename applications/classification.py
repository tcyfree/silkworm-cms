...
from applications.core import get_model_from_name
from _utils.utils import (cvtColor, get_classes, letterbox_image,
                          preprocess_input)
...
class Classification(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'static/model_data/ep185-loss0.172-val_loss0.249.pth',
        "classes_path"      : 'static/model_data/cls_classes.txt',
        #--------------------------------------------------------------------#
        #   输入的图片大小
        #--------------------------------------------------------------------#
        "input_shape"       : [224, 224],
...
if __name__ == '__main__':
    ...
    x = Image.open(x)
    class_name = yolo5.detect_image(x)
    print(class_name)